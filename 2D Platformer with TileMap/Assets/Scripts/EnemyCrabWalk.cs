...
public class EnemyCrabWalk : MonoBehaviour
{

    public float chaseRange = 4f;
    public float enemyMovemntSpeed = 1.5f;
    ...
    {
        rb.velocity=  new Vector2(playerDirection.x * enemyMovemntSpeed,rb.velocity.y);
